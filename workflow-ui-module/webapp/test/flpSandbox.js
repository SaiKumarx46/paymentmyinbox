		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task UI app title",
									"targetURL": "#paymentNamespaceworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"paymentNamespaceworkflowuimodule-display": {
								"semanticObject": "paymentNamespaceworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=paymentNamespace.workflowuimodule",
									"url": sap.ui.require.toUrl("paymentNamespace/workflowuimodule")
								}
							}
						}
					}
